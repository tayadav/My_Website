...
movies %>%
  ...
  summarise(average_gross_earnings = mean(gross), 
            average_budget = mean(budget),
            average_return_on_budget = mean(return_on_budget)
            )%>%
...
movies %>%
  ...
  summarise(total_gross = sum(gross),
            mean_directors = mean(gross),
            median_directors =median(gross),
            sd_directors = sd(gross)) %>%
...
movies %>%
  group_by(genre) %>%
  summarise(average_ratings = mean(rating),
